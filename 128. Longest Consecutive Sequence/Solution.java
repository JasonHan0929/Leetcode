public class Solution {
    public int longestConsecutive(int[] nums) {
        ...
        return Math.max(max, curSum);// the last value of curNum will not update the max since while loop has already closed before Math.max is revoked
    }
}//treeset, the time to build a BST is O(nlogn)?
